...
def randFBAN():
  VAPP = random.randint(410000000,499999999)
  ua="[FBAN/FB4A;FBAV/309.0.0.47.119;FBBV/"+str(VAPP)+";FBDM/{density=3.0,width=1080,height=2131};FBLC/en_GB;FBRV/279865282;FBCR/1030;FBMF/samsung;FBBD/SM-C5010;FBPN/com.facebook.katana;FBDV/"+random.choice(model2)+";FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"
  return ua

def randBuildvsskj():
    END = '[FBAN/Orca-Android;FBAV/248.0.0.7.127;FBBV/194293860;[FBAN/Orca-Android;FBAV/248.0.0.7.127;FBPN/com.facebook.orca;FBLC/en_GB;FBBV/194293860;FBCR/null;FBMF/samsung;FBBD/samsung;FBDV/SM-C5010;FBSV/10;FBCA/arm64-v8a:null;FBDM/{density=2.625,width=1080,height=2131};FB_FW/1;]'
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(model2)}  Build/SP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    return ua
...
def danger_menu():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Kkiijj/D2/blob/main/De.txt").text
    if id in DARK:
        DANGER()
    else:
        os.system("clear")
